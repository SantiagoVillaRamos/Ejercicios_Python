...
from clases_formulario import FormularioDepositarDinero
from interfaz import InterfazEjecutarAccion

class FormularioDepositarDineroUsuario(InterfazEjecutarAccion):
    
    def __init__(self):
        self.__lista_opciones = None
        self.respuestas = {
            'depositar': FormularioDepositarDinero(),
        }
        self.__datos = {}
