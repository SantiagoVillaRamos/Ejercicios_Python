...
from clases_formulario import FormularioNombreEmpleado, FormularioSalarioEmpleado, FormularioNombreNuevoEmpleado
...
class Formulario(InterfazEjecutarAccion):
    ...
    def __init__(self):
        ...
        self.respuestas = {
            'nombre': FormularioNombreEmpleado(),
            'salario': FormularioSalarioEmpleado(),
        }
        self.__datos = {}
...
class FormularioNombreNuevo(InterfazEjecutarAccion):
    
    def __init__(self):
        self.__lista_opciones = None
        self.respuestas = {
            'nombre': FormularioNombreEmpleado(),
            'nuevo_nombre': FormularioNombreNuevoEmpleado(),
        }
        self.__datos = {}
