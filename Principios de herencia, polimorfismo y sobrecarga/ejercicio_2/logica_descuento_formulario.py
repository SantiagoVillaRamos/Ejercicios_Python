...
from clases_formulario import FormularioDescuento, FormularioProducto
from interfaz import InterfazEjecutarAccion


class FormularioDescuentoProducto(InterfazEjecutarAccion):
    
    def __init__(self):
        self.__lista_opciones = None 
        self.respuestas = {
            'producto': FormularioProducto(), 
            'descuento': FormularioDescuento(),
        }
        self.__datos = {}
